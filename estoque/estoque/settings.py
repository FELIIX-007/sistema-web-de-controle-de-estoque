...
SECRET_KEY = 'django-insecure-*y!twp%p4x8@ox@f1s_n@(aj8&v!$361(g(xx&(7@-idqzs(bc'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'produtos/static'),  # Certifique-se de que este diretório existe
]
